    ...
    <div className="mx-auto flex max-w-3xl flex-col gap-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-2 text-sm leading-relaxed text-muted-foreground">
          ...
          <p>
            非核心科目（地理、公經社、中史、歷史、佛化教育、科學）以作為學習的評估為主，對齊即將到來的測驗／考試重點。
          </p>
          <p>時間 20 分鐘；題量約為測驗一半。選擇／填充／配對不超過總分 30%。避免開放題以便互評。</p>
          <p>達標學生 16:15 後離校；不達標須重測。重測形式不限（整份、部分、口頭、抽問），分數不在本計算器輸入。</p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="space-y-2 text-sm leading-relaxed">
          <p>
            每次評估百分率 =（得分 ÷ 該卷滿分）× 100。只記原卷分數，不要輸入重測分。
          </p>
          <p>預設及格線 50%。課後評估預設滿分 20；測驗／考試預設滿分 100。各班、各上課組（原班／抽離）可在成績表「滿分」列分開更改。</p>
          <p>
